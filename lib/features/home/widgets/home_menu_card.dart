...
class HomeMenuCard extends ConsumerStatefulWidget {
  const HomeMenuCard({super.key});

  @override
  ConsumerState<HomeMenuCard> createState() => _HomeMenuState();
}

class _HomeMenuState extends ConsumerState<HomeMenuCard> {
